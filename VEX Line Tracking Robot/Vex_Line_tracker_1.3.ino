  ...
  switch(ui_Robot_State_Index)
  {
    ...
    case 1:    //Robot Run after 3 seconds
    {
      if(bt_3_S_Time_Up)
      {
       ...
       /*************************************************************************************/
       //1500 = stop   Motor Speeds 
       //1500-2000 = forward
       //500-1500 = reverse    
       //Code for light background and dark line 
       unsigned int threshold=512; 
       //ASDFADSFASDXFASDFXASDFXASDFXSADFX
        if(ui_Middle_Line_Tracker_Data>=threshold)
        {
          //if the middle line tracker is on the line, set motors speeds to same value and go straight 
          ui_Left_Motor_Speed= 1600; 
          ui_Right_Motor_Speed= 1600; 
          Serial.println("MIDDLE");
          
        }
        else if(ui_Left_Line_Tracker_Data >= threshold)
        {
          //if left and middle are off, turn right 
        ...
        {
          //if middle line tracker and right line tracker are off the line, turn left 
          ui_Left_Motor_Speed= 0; 
          ui_Right_Motor_Speed= 1650;
          Serial.println("Turn Left"); 
        }
//        if(ui_Left_Line_Tracker_Data<=ui_Left_Line_Tracker_Dark&&ui_Middle_Line_Tracker_Data<=ui_Middle_Line_Tracker_Dark && ui_Right_Line_Tracker_Data<=ui_Right_Line_Tracker_Dark)
//        {
//          // if all line trakcers are light, stop
//          ui_Left_Motor_Speed= 1500; 
//          ui_Right_Motor_Speed= 1500;  
//        }
        if(ui_Left_Line_Tracker_Data>=threshold && ui_Middle_Line_Tracker_Data>=threshold && ui_Right_Line_Tracker_Data>=threshold)
        {
          // if all line trackers are dark stop 
          ui_Left_Motor_Speed= 0; 
          ui_Right_Motor_Speed= 0;
        }
